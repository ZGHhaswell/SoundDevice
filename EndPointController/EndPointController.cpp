...
HRESULT SetDefaultAudioPlaybackDevice(LPCWSTR devID)
{
	...
	if (SUCCEEDED(hr))
	{
		hr = pPolicyConfig->SetDefaultEndpoint(devID, console);
		hr = pPolicyConfig->SetDefaultEndpoint(devID, multimedia);
		hr = pPolicyConfig->SetDefaultEndpoint(devID, communications);
